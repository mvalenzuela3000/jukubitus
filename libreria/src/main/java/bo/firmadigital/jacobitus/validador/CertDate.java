...
import bo.firmadigital.jacobitus.validador.ContentsChecker.Estado;
...
public class CertDate {
    ...
    private OCSPData ocsp = new OCSPData(Validador.OCSPState.UNKNOWN, null);
    ...
    public boolean isOCSP() {
        return ocsp.getState() == Validador.OCSPState.OK || ocsp.getState() == Validador.OCSPState.ALERT;
    }
    ...
    public boolean isOCSPAlerted() {
        return ocsp.getState() == Validador.OCSPState.ALERT;
    }
}
