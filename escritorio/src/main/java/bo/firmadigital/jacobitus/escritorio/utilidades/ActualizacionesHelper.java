...
import bo.firmadigital.jacobitus.escritorio.comun.actualizaciones.VersionResponse;

public class ActualizacionesHelper {
    ...
    public ActualizacionesHelper(String enlaceBaseDescarga) {
