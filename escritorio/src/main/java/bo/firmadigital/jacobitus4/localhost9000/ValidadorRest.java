...
import bo.firmadigital.jacobitus4.localhost9000.dtos.ValidacionArchivoDto;
import bo.firmadigital.jacobitus4.localhost9000.dtos.ValidacionPdfDto;
import bo.firmadigital.jacobitus4.localhost9000.servicios.ValidadorServicio;
...
public class ValidadorRest {
     ...
     *
     * @apiParam {String} pdf Archivo pdf en base64 que se desea validar.
     *
    ...
    public String validarPdf(InputStream body) {
        ...
        //         Validador validar = new ValidadorPdf(new ByteArrayInputStream(file), this.getOpciones());
     ...
     * @apiHeader {String} [Content-Type=application/json] Tipo de contenido
     *
     * @apiParam {String} file Archivo p7s en base64 que se desea validar.
     *
     * @apiParamExample {json} Request-Example:
     * {
     *     "file": "MII...truncated...=="
    ...
    public String validarPKCS7(InputStream body) {
        ...
        //         Validador validar = new ValidadorPKCS7(new ByteArrayInputStream(file), this.getOpciones());
        //         JSONArray firmas = new JSONArray();
        //         datos.put("firmas", firmas);
        //         for (CertDate cert : validar) {
        //             JSONObject firma = new JSONObject();
    ...
    /**
     * @api {post} /api/validar_xml Validar firma de un documento xml.
     * @apiGroup Validador
     * @apiVersion 1.0.0
     *
     * @apiHeader {String} [Content-Type=application/json] Tipo de contenido
     *
     * @apiParam {String} file Archivo XML en base64 que se desea validar.
     *
     * @apiParamExample {json} Request-Example:
     * {
     *     "file": "MII...truncated...==",
    ...
    public String validarXml(InputStream body) {
        ...
        //         Validador validar = new ValidadorXml(new ByteArrayInputStream(file), this.getOpciones());
        //         JSONArray firmas = new JSONArray();
        //         datos.put("firmas", firmas);
        //         for (CertDate cert : validar) {
        //             JSONObject firma = new JSONObject();
    ...
    /**
     * @api {post} /api/validar_jws Validar firma de un documento jws.
     * @apiGroup Validador
     * @apiVersion 1.0.0
     *
     * @apiHeader {String} [Content-Type=application/json] Tipo de contenido
     *
     * @apiParam {String} file Archivo JWS en base64 que se desea validar.
     *
     * @apiParamExample {json} Request-Example:
     * {
     *     "file": "MII...truncated...==",
    ...
    public String validarJws(InputStream body) {
        ...
        //         Validador validar = new ValidadorJws(new ByteArrayInputStream(file), this.getOpciones());
        //         JSONArray firmas = new JSONArray();
        //         datos.put("firmas", firmas);
        //         for (CertDate cert : validar) {
        //             JSONObject firma = new JSONObject();
